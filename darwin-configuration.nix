...
}:
{
  ...
  # Fonts — installed so macOS CoreText (and ghostty) can see them.
  ...
  # NOTE (tor gateway): Tor Browser's control-port manager overrides ALL
  # file-level config (torrc AND torrc-defaults) at launch — verified via
