...
{
  home.file.".pi/pi-pop.json".source = ../../../home/.pi/pi-pop.json;
  ...
  home.file.".pi/agent/agents".source = ../../../home/.pi/agent/agents;
  home.file.".pi/agent/themes".source = ../../../home/.pi/agent/themes;
}
